/** Normalize and validate Belarus mobile numbers for API. */
...
/**
 * Accepts common user inputs; returns compact `+375XXXXXXXXX` or null to clear.
 * Empty / whitespace-only → null (clear field).
 */

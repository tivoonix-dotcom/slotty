...
import { apptCardDetailLink } from '../../admin/appointments/adminAppointmentsTheme';
import {
...
import { buildClientNotificationCardModel } from './clientNotificationModel';
...
function compactListSubtitle(
  card: ReturnType<typeof buildClientNotificationCardModel>,
): string | null {
...
export function ClientNotificationCard({ item, index = 0, onOpen, onMarkRead }: Props) {
  const card = useMemo(() => buildClientNotificationCardModel(item), [item]);

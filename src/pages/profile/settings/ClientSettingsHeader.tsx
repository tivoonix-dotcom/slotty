...
import { PROFILE_SETTINGS_PATH } from '../../../app/paths';
...
export function ClientSettingsHeader({ breadcrumb, title, description, actions }: Props) {
  return (
    <header className="mb-6 min-w-0">
      <nav className="text-[13px] text-[#9CA3AF]" aria-label="Хлебные крошки">
        <Link to={PROFILE_SETTINGS_PATH} className="transition hover:text-[#6B7280]">
          Настройки
        </Link>

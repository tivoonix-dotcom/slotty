...
export function ServiceCategoryResultsHeader({
  categoryName,
  count,
  sortBy,
  onSortChange,
  ...
  return (
    <div className="flex flex-wrap items-end justify-between gap-3">
      <div className="min-w-0">
        <h2 className="text-[17px] font-bold tracking-[-0.03em] text-[#111827] lg:text-[18px]">
          Мастера · {categoryName}
        </h2>
        <p className="mt-0.5 text-[13px] text-[#6B7280]">{mastersCountLabel(count)}</p>
      </div>
      <CatalogSortSelect
        value={sortBy}
